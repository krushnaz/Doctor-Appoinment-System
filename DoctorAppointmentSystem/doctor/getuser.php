        ...
        echo "   <table class='table table-hover'>";
            ...
            echo "  <tbody>";
                ...
                <tr>
                    ...
                    echo "<td><a href='../patient/get_appointment.php?&appid=" . $row['scheduleId'] . "&scheduleDate=".$q."' class='btn btn-".$btnclick." btn-xs' role='button' ".$btnstate.">Book Now</a></td>";
                    // echo "<td><a href='get_appointment.php?&appid=" . $row['scheduleId'] . "&scheduleDate=".$q."'>book</a></td>";
